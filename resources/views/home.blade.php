...
<html lang="en">
  ...
  <body>
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-language dropdown d-none d-md-block">
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
                ...
                <a class="dropdown-item" href="#">
                  <div class="nav-language-icon mr-2">
                    <i class="flag-icon flag-icon-fr" title="GB" id="gb"></i>
                  </div>
                  <div class="nav-language-text">
    ...
    <p class="mb-1 text-black">ilyas</p>
</div>

              </a>
              <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                <div class="p-3 text-center bg-primary">
                  <img class="img-avatar img-avatar48 img-avatar-thumb" src="assets/images/faces/face29.png" alt="">
                </div>
                <div class="p-2">
                  ...
                  <a href="logout.php" class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="#">
                    <span>Log Out</span>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="fournisseur_table.php">
